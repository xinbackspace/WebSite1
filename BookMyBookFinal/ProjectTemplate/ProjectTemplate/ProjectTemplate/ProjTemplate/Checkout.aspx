<%@ Page Title="Checkout" Language="C#" MasterPageFile="~/BalloonShop.master" AutoEventWireup="true" CodeFile="Checkout.aspx.cs" Inherits="Checkout" %>
...
&nbsp;&nbsp;&nbsp;
    ...
    <br />
    <asp:Label ID="order" runat="server" Text="Your item has been shipped..." Visible="false" ForeColor="Green"/>
</asp:Content>