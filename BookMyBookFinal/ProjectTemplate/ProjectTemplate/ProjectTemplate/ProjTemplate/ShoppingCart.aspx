<%@ Page Title="Shopping Cart" Language="C#" MasterPageFile="~/BalloonShop.master" AutoEventWireup="true" CodeFile="ShoppingCart.aspx.cs" Inherits="ShoppingCart" %>
  ...
  <table width="100%">
    <tr>
      ...
      <td align="right">
        ...
        <asp:Button ID="Button1" runat="server" CssClass="SmallButtonText" Text="Rent" OnClick="Button1_Click" />
          <asp:Button ID="checkoutButton" runat="server" CssClass="SmallButtonText" Text="Buy" OnClick="checkoutButton_Click" />
      </td>
    </tr>
  </table>
  <br />
